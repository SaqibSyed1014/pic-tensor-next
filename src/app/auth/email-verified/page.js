            ...
            <div className={styles.authFormLayout}>
                ...
                <div className="flex flex-col items-center gap-5">
                    ...
                    <div className="relative">
                        <input type="text" placeholder="Write Prompt to generate image" className="w-[740px] h-16 placeholder:text-light bg-lime-dark border-0 outline-0 py-2 px-3 rounded-[800px]" />
                        <BaseButton
